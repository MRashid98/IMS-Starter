...
public class ItemControllerTest {
	...
	public void testCreate() {
		final String I_NAME = "Phone Case";
		final Float I_PRICE = 4.99f;
		final Item created = new Item(I_NAME, I_PRICE);

		Mockito.when(utils.getString()).thenReturn(I_NAME);
		Mockito.when(utils.getFloat()).thenReturn(I_PRICE);
	...
	public void testReadAll() {
		...
		items.add(new Item(1L, "Phone", 499.99F));
	...
	public void testUpdate() {
		Item updated = new Item(1L, "Phone", 599.99F);
